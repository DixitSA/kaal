...
export default function Dashboard() {
  ...
  return (
    <div style={{ minHeight: "100dvh" }} className="relative">
      {/* Top bar */}
      <div className="fixed top-0 left-0 right-0 z-20 pointer-events-none" style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 5vw" }}>
        <div className="flex items-center justify-between" style={{ maxWidth: "1100px" }}>
