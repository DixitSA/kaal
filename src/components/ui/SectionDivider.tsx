...
export default function SectionDivider({ width = 180, opacity = 0.45, style }: SectionDividerProps) {
      ...
      >
        <defs>
          <linearGradient id="fadeLine" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="15%" stopColor="#5C574F" stopOpacity="0.6" />
            <stop offset="50%" stopColor="#5C574F" stopOpacity="1" />
            <stop offset="85%" stopColor="#5C574F" stopOpacity="0.6" />
        ...
        <circle cx={width * 0.5} cy={width * 0.25} r="4" fill="none" stroke="#5C574F" strokeWidth="0.8" />
        <circle cx={width * 0.5} cy={width * 0.25} r="2" fill="#5C574F" />
        
        <g stroke="#5C574F" strokeWidth="0.5" fill="none">
